...
def group(noise_csv,lable_csv, normal_file,abnormal_file):
    ...
    for var in dict_blk_id:
        if dict_blk_id_label[var] == 'Normal':
            ...
            f_abnormal.write(str(dict_blk_id[var])+'\n')
...
def train_dataset_split(total_file,p,train_file,test_file):
    ...
    #list_train = random.shuffle(list_train)
    #print(list_train)
...
if __name__ == "__main__":
    ...
    #data_match_logkey
    dir_row = 'data_match_logkey/dataset_10'
    #group_row('data/HDFS.log','data/anomaly_label.csv',dir_row+'/hdfs_normal',dir_row+'/hdfs_abnormal')
    train_dataset_split( 'data_match_logkey/hdfs_normal', 0.1 , dir_row + '/hdfs_train',dir_row + '/hdfs_test_normal')

    #dir_noise = 'data_noise/drain_noise_10' #var=0 1553705 21540151 7.213065
    #dir_noise = 'data_noise/drain_noise_20'#var=0 1423611 21467936 6.631336
    #dir_noise = 'data_noise/drain_noise_50'#var=0 1064555 21245976 5.010619
    #dir_noise = 'data_noise/drain_noise_50'  # var=0 1488849 21503547 6.923737
    #dir_noise = 'data_noise/drain_noise_50'  #

    #dir_noise = 'data_noise/noise_10'
    #add_noise('data/HDFS.log',0.3,dir_noise+'/HDFS_noise.log')
    '''
    train_p = 0.1
    sim_throad_0 = 1
    p_num = 0.32
    dir_noise = 'data_noise/train_10'  #
    #add_noise('data/HDFS.log',0.3,dir_noise+'/HDFS_noise.log')

    #group(dir_noise + '/HDFS_noise.log_structured.csv', 'data/anomaly_label.csv', dir_noise + '/normal',dir_noise + '/abnormal')
    #csvtemplates_to_templates(dir_noise + '/HDFS_noise.log_templates.csv', dir_noise + '/templates_noise')
    #get_map_logkey_to_num(dir_noise + '/templates_noise', dir_noise + '/map_logkey_to_num')
    #map_logkey_to_num(dir_noise + '/map_logkey_to_num', dir_noise + '/normal', dir_noise + '/hdfs_train_normal')
    #map_logkey_to_num(dir_noise + '/map_logkey_to_num', dir_noise + '/abnormal', dir_noise + '/hdfs_test_abnormal')
    #train_dataset_split(dir_noise + '/hdfs_train_normal', train_p, dir_noise + '/hdfs_train',dir_noise + '/hdfs_test_normal')
    get_importain_word_txt('data_noise/col_header.txt', 100, dir_noise + '/col_header_important_word')
    get_importain_word_csv(dir_noise + '/HDFS_noise.log_templates.csv', 100, dir_noise + '/templates_important_word')
    get_map_unkonw_tmp_to_exist(dir_noise + '/col_header_important_word', dir_noise + '/templates_important_word',dir_noise + '/map_know_to_exist')
    get_map_unkonw_tmp_to_0(dir_noise + '/col_header_important_word',sim_throad_0, dir_noise + '/templates_important_word',dir_noise + '/map_know_to_0')

    get_map_0_to_exist(p_num,dir_noise + '/map_know_to_0',dir_noise + '/map_know_to_exist',dir_noise + '/map_know_to_0_new')

    unknown_logkey_to_old_logkey(dir_noise + '/map_know_to_exist', dir_noise + '/hdfs_train',dir_noise + '/WITH_S_train')
    unknown_logkey_to_old_logkey(dir_noise + '/map_know_to_exist', dir_noise + '/hdfs_test_normal',dir_noise + '/WITH_S_test_normal')
    unknown_logkey_to_old_logkey(dir_noise + '/map_know_to_exist', dir_noise + '/hdfs_test_abnormal',dir_noise + '/WITH_S_test_abnormal')
    # deeplog
    unknown_logkey_to_old_logkey(dir_noise + '/map_know_to_0_new', dir_noise + '/hdfs_test_normal',dir_noise + '/Deeplog_test_normal')
    unknown_logkey_to_old_logkey(dir_noise + '/map_know_to_0_new', dir_noise + '/hdfs_test_abnormal', dir_noise + '/Deeplog_test_abnormal')
    count_deeplog_0(dir_noise + '/Deeplog_test_normal',dir_noise + '/Deeplog_test_abnormal')
    count_total(dir_noise + '/WITH_S_test_normal',dir_noise + '/Deeplog_test_normal',dir_noise + '/Deeplog_test_abnormal')
    count_logkey_0_in_map_0(dir_noise + '/map_know_to_0_new')
    '''

    #group_row('data/HDFS.log','data/anomaly_label.csv',dir_row+'/hdfs_normal',dir_row+'/hdfs_abnormal')
    #train_dataset_split(dir_row + '/hdfs_normal', 0.0085, dir_row + '/hdfs_train',dir_row + '/hdfs_test_normal')
    #'''
    #dir_noise = 'data_noise/noise_0.016'
    #count_deeplog_0(dir_noise + '/Deeplog_test_normal',dir_noise + '/Deeplog_test_abnormal')
    #count_total(dir_noise + '/WITH_S_test_normal',dir_noise + '/Deeplog_test_normal',dir_noise + '/Deeplog_test_abnormal')
    #dir_row = 'data_noise/row_dataset'
    #dir_noise = 'data_noise/drain_noise_0'

    #count_total(dir_noise + '/WITH_S_test_normal',dir_noise + '/Deeplog_test_normal',dir_noise + '/Deeplog_test_abnormal')
    #count_total(dir_noise + '/WITH_S_train',dir_noise + '/WITH_S_test_abnormal',dir_noise + '/WITH_S_test_normal')
    #count_total(dir_row+'/hdfs_train',dir_row+'/hdfs_test_normal',dir_row+'/hdfs_abnormal')
    #count_total('data/hdfs_train','data/hdfs_test_normal','data/hdfs_test_abnormal')

    '''
    #--------------------------------------------------------------------------------
    dir_noise = 'data_noise/drain_noise_0'
    dir_cmp = 'data_noise/drain_compare_total'
    group_cmp(dir_noise+'/HDFS_noise.log_structured.csv','data/anomaly_label.csv' ,dir_cmp+'/noise_0')
    map_logkey_to_num(dir_noise+'/map_logkey_to_num',dir_cmp+'/noise_0',dir_cmp+'/noise_0_1')
    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_exist',dir_cmp+'/noise_0_1',dir_cmp+'/WITH_S_train')
    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_0',dir_cmp+'/noise_0_1',dir_cmp+'/Deeplog_test_abnormal')
    group_row('data/HDFS.log','data/anomaly_label.csv',dir_cmp+'/row_logkey')
    '''
    #dir_cmp = 'data_noise/drain_compare_total'
    #compare_two_file(dir_cmp+'/row_logkey',dir_cmp+'/WITH_S_train')
    #count_logky(dir_cmp + '/Deeplog_test_abnormal')
    #count_logky(dir_cmp + '/row_logkey')
    #count_logky(dir_cmp + '/WITH_S_train')

    #count_deeplog_0(dir_cmp + '/WITH_S_test_normal',dir_cmp + '/WITH_S_test_abnormal')
    #'''
    #add noise in HDFS
    #add_noise('data/HDFS.log',0.20,'data_noise/noise_20/HDFS_noise_20.log')
    #use drain to parse log
    #group by block_id
    #group('data_noise/noise_20/HDFS_noise_20.log_structured.csv','data/anomaly_label.csv' ,'data_noise/noise_20/normal','data_noise/noise_20/abnormal')
    #split_data_top('data/HDFS.log', 0.01 , 'data/HDFS_1.log')
    #filte_log('data/HDFS_1.log','data_noise/HDFS_filter_001.log')
    #word2vec_train('data_noise/HDFS_filter_001.log', 'data_noise/word2vec_model_100d', 'data_noise/word2vec_model_100d_model')
    #csvtemplates_to_templates('data_noise/noise_20/HDFS_noise_20.log_templates.csv','data_noise/noise_20/templates_noise')
    #get_importain_word_Tf_idf('data_noise/word2vec_full.txt','data_noise/noise_20/templates_noise','data_noise/glove.6B.100d.word2vec.txt',4,'data_noise/noise_20/event_vector_top3.txt','data_noise/noise_20/logkey2vec_4_save')
    #get_map_logkey_to_num('data_noise/noise_20/templates_noise','data_noise/noise_20/map_logkey_to_num')
    #map_logkey_to_num('data_noise/noise_20/map_logkey_to_num','data_noise/noise_20/normal','data_noise/noise_20/dataset_normal')
    #map_logkey_to_num('data_noise/noise_20/map_logkey_to_num','data_noise/noise_20/abnormal','data_noise/noise_20/hdfs_test_abnormal')
    #train_dataset_split('data_noise/noise_20/dataset_normal',0.01,'data_noise/noise_20/TRAIN','data_noise/noise_20/hdfs_test_normal')
    #save_logkey_in_dataset_normal('data_noise/noise_20/hdfs_test_normal', 'data_noise/noise_20/train_logkey')
    #save_logkey_in_dataset_test('data_noise/noise_20/hdfs_test_abnormal','data_noise/noise_20/hdfs_test_normal','data_noise/noise_20/test_logkey')

    #get_importain_word_txt('data_noise/col_header.txt',4,'data_noise/col_header_important_word')
    #get_importain_word_csv('data_noise/noise_20/HDFS_noise_20.log_templates.csv',4,'data_noise/noise_20/templates_important_word')
    #get_map_unkonw_tmp_to_exist('data_noise/col_header_important_word','data_noise/noise_20/templates_important_word','data_noise/noise_20/map_know_to_exist')
    #get_map_unkonw_tmp_to_0('data_noise/col_header_important_word','data_noise/noise_20/templates_important_word','data_noise/noise_20/map_know_to_0')

    #map_testdataset_logkey_to_traindataset_logkey('data_noise/noise_20/train_logkey','data_noise/noise_20/test_logkey','data_noise/noise_20/event_vector_top3.txt','data_noise/noise_20/map')

    #unknown_logkey_to_old_logkey('data_noise/noise_20/map_know_to_exist','data_noise/noise_20/TRAIN','data_noise/noise_20/WITH_S_train')
    #unknown_logkey_to_old_logkey('data_noise/noise_20/map_know_to_exist','data_noise/noise_20/hdfs_test_normal','data_noise/noise_20/WITH_S_test_normal')
    #unknown_logkey_to_old_logkey('data_noise/noise_20/map_know_to_exist','data_noise/noise_20/hdfs_test_abnormal','data_noise/noise_20/WITH_S_test_abnormal')
    #deeplog
    #unknown_logkey_to_old_logkey('data_noise/noise_20/map_know_to_0','data_noise/noise_20/hdfs_test_normal','data_noise/noise_20/Deeplog_test_normal')
    #unknown_logkey_to_old_logkey('data_noise/noise_20/map_know_to_0','data_noise/noise_20/hdfs_test_abnormal','data_noise/noise_20/Deeplog_test_abnormal')

    '''
    #noise 5%
    #add noise in HDFS
    dir_noise = 'data_noise/noise_5'
    #add_noise('data/HDFS.log',0.05,dir_noise+'/HDFS_noise_5.log')
    #use drain to parse log
    #group by block_id
    #group(dir_noise+'/HDFS_noise_5.log_structured.csv','data/anomaly_label.csv' ,dir_noise+'/normal',dir_noise+'/abnormal')
    #csvtemplates_to_templates(dir_noise+'/HDFS_noise_5.log_templates.csv',dir_noise+'/templates_noise')
    #get_map_logkey_to_num(dir_noise+'/templates_noise',dir_noise+'/map_logkey_to_num')
    #map_logkey_to_num(dir_noise+'/map_logkey_to_num',dir_noise+'/normal',dir_noise+'/hdfs_train_normal')
    #map_logkey_to_num(dir_noise+'/map_logkey_to_num',dir_noise+'/abnormal',dir_noise+'/hdfs_test_abnormal')
    #train_dataset_split(dir_noise+'/hdfs_train_normal',0.01,dir_noise+'/hdfs_train',dir_noise+'/hdfs_test_normal')
    get_importain_word_txt('data_noise/col_header.txt',100,dir_noise+'/col_header_important_word')
    get_importain_word_csv(dir_noise+'/HDFS_noise_5.log_templates.csv',100,dir_noise+'/templates_important_word')
    get_map_unkonw_tmp_to_exist(dir_noise+'/col_header_important_word',dir_noise+'/templates_important_word',dir_noise+'/map_know_to_exist')
    get_map_unkonw_tmp_to_0(dir_noise+'/col_header_important_word',dir_noise+'/templates_important_word',dir_noise+'/map_know_to_0')

    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_exist',dir_noise+'/hdfs_train',dir_noise+'/WITH_S_train')
    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_exist',dir_noise+'/hdfs_test_normal',dir_noise+'/WITH_S_test_normal')
    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_exist',dir_noise+'/hdfs_test_abnormal',dir_noise+'/WITH_S_test_abnormal')
    #deeplog
    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_0',dir_noise+'/hdfs_test_normal',dir_noise+'/Deeplog_test_normal')
    unknown_logkey_to_old_logkey(dir_noise+'/map_know_to_0',dir_noise+'/hdfs_test_abnormal',dir_noise+'/Deeplog_test_abnormal')
    '''

    #noise 20%
    #add noise in HDFS
    #dir_noise = 'data_noise/new_noise_20'
    #add_noise('data/HDFS.log',0.20,dir_noise+'/HDFS_noise_20.log')
    #use drain to parse log
    #group by block_id

    '''
    group(dir_noise+'/HDFS_noise_20.log_structured.csv','data/anomaly_label.csv' ,dir_noise+'/normal',dir_noise+'/abnormal')
    csvtemplates_to_templates(dir_noise+'/HDFS_noise_20.log_templates.csv',dir_noise+'/templates_noise')
    get_map_logkey_to_num(dir_noise+'/templates_noise',dir_noise+'/map_logkey_to_num')
    map_logkey_to_num(dir_noise+'/map_logkey_to_num',dir_noise+'/normal',dir_noise+'/hdfs_normal')
    map_logkey_to_num(dir_noise+'/map_logkey_to_num',dir_noise+'/abnormal',dir_noise+'/hdfs_test_abnormal')
    train_dataset_split(dir_noise+'/hdfs_normal',0.01,dir_noise+'/hdfs_train',dir_noise+'/hdfs_test_normal')
    get_importain_word_txt('data_noise/col_header.txt',100,dir_noise+'/col_header_important_word')
    get_importain_word_csv(dir_noise+'/HDFS_noise_20.log_templates.csv',100,dir_noise+'/templates_important_word')
    ...
    #add noise in HDFS
    #dir_noise = 'data_noise/drain_noise_0'
    #add_noise('data/HDFS.log',0.0,dir_noise+'/HDFS_noise.log')
    #use drain to parse log
    #group by block_id
    ...
    count_map_to_exist_logkey(dir_noise+'/map_know_to_exist')
    '''