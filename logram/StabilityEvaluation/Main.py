...
# doubleDictionaryList, triDictionaryList, allTokenList , len = dictionaryBuilder(Zookeeper_format, '../TestLogs/Zookeeper/Zookeeper_2k.log', Zookeeper_Regex)
doubleDictionaryList, triDictionaryList, allTokenList , len = dictionaryBuilder(HDFS_format, '../TestLogs/HDFS/HDFS_2k.log', HDFS_Regex)
# doubleDictionaryList, triDictionaryList, allTokenList , len = dictionaryBuilder(HDFS_format, '../TestLogs/HDFS/HDFS_1k.log', HDFS_Regex)
...
# evaluate('../TestLogs/HDFS/HDFS_1k.log_templates.csv', 'Output/template.csv')
