...
def simple_dataset_base_line(total_file, num ,train_file):
    total_f = open(total_file,mode='r')
    train_f = open(train_file,mode='w')
...
def combin_sprak_file():
    path = "../logs/Spark/dir" #文件夹目录
    files= os.listdir(path) #得到文件夹下的所有文件名称


    count = 0
    s = []
    f_write =  open('../logs/Spark/Spark.log', 'w')
    for root, dirs, files in os.walk(path):
        # print(dirs)
        # print(files)
        for dir in dirs:
            # print(path+'/'+ dir)
            for file in os.listdir(path+'/'+ dir): #得到文件夹下的所有文件名称
                # print(path+'/'+ dir + '/' + file)
                if not os.path.isdir( path+'/'+ dir + '/' + file): #判断是否是文件夹，不是文件夹才打开
                    f = open(path+'/'+ dir + '/' + file); #打开文件
                    # iter_f = iter(f); #创建迭代器
                    for line in f.readlines(): #遍历文件，一行行遍历，读取文本
                        if len(line) < 200 and line[:8] == '17/06/09':
                            f_write.write(line)
                            count += 1
            ...
            #     if not os.path.isdir( root +"/"+file): #判断是否是文件夹，不是文件夹才打开
...
if __name__ == "__main__":
    ...
    # simple_dataset_base_line(  '../logs/BGL/BGL.log', 100 ,  '../logs/BGL/BGL_100.log')
    # simple_dataset_base_line(  '../logs/BGL/BGL.log', 1000 ,  '../logs/BGL/BGL_1k.log')
    # simple_dataset_base_line(  '../logs/BGL/BGL.log', 10000 ,  '../logs/BGL/BGL_10k.log')
    # simple_dataset_base_line(  '../logs/BGL/BGL.log', 100000 ,  '../logs/BGL/BGL_100k.log')
    # simple_dataset_base_line(  '../logs/BGL/BGL.log', 1000000 ,  '../logs/BGL/BGL_1m.log')

    # simple_dataset_base_line(  '../logs/Andriod/Andriod.log', 100 ,  '../logs/Andriod/Andriod_100.log')
    # simple_dataset_base_line(  '../logs/Andriod/Andriod.log', 1000 ,  '../logs/Andriod/Andriod_1k.log')
    # simple_dataset_base_line(  '../logs/Andriod/Andriod.log', 10000 ,  '../logs/Andriod/Andriod_10k.log')
    # simple_dataset_base_line(  '../logs/Andriod/Andriod.log', 100000 ,  '../logs/Andriod/Andriod_100k.log')
    # simple_dataset_base_line(  '../logs/Andriod/Andriod.log', 1000000 ,  '../logs/Andriod/Andriod_1m.log')

    # simple_dataset_base_line(  '../logs/OpenSSH/OpenSSH.log', 600 ,  '../logs/OpenSSH/OpenSSH_600.log')
    # simple_dataset_base_line(  '../logs/OpenSSH/OpenSSH.log', 6000 ,  '../logs/OpenSSH/OpenSSH_6k.log')
    # simple_dataset_base_line(  '../logs/OpenSSH/OpenSSH.log', 60000 ,  '../logs/OpenSSH/OpenSSH_60k.log')
    # simple_dataset_base_line(  '../logs/OpenSSH/OpenSSH.log', 600000 ,  '../logs/OpenSSH/OpenSSH_600k.log')

    combin_sprak_file()

    simple_dataset_base_line(  '../logs/Spark/Spark.log', 100 ,  '../logs/Spark/Spark_100.log')
    simple_dataset_base_line(  '../logs/Spark/Spark.log', 1000 ,  '../logs/Spark/Spark_1k.log')
    simple_dataset_base_line(  '../logs/Spark/Spark.log', 10000 ,  '../logs/Spark/Spark_10k.log')
    simple_dataset_base_line(  '../logs/Spark/Spark.log', 100000 ,  '../logs/Spark/Spark_100k.log')
    simple_dataset_base_line(  '../logs/Spark/Spark.log', 1000000 ,  '../logs/Spark/Spark_1m.log')
