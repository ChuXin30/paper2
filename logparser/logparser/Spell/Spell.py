...
class LogParser:
    ...
    def PrefixTreeMatch(self, parentn, seq, idx , count):
        retLogClust = None
        length = len(seq)
        for i in range(idx, length):
            if seq[i] in parentn.childD:
                ...
                if (childn.logClust is not None):
                    ...
                    return   self.PrefixTreeMatch(childn, seq, i + 1 , count)
    ...
    def parse(self, logname):
        ...
        for idx, line in self.df_log.iterrows():
            ...
            # print (constLogMessL)
            matchCluster = self.PrefixTreeMatch(rootNode, constLogMessL, 0 , 0.0)
            # print (sim)
